...
Among the available learning rules of this type, the \emph{backpropagation} algorithm, which is explained in \secref{generalbackprop}, has been the centre of our attention. 
