...
\documentclass[a4paper,10pt,english]{report} %book, report, article
...
\input{neuralnetworks/intro}
\section{Biological Neural Networks}
\input{neuralnetworks/biologicalnn}
\section{Artificial Neural Networks}
\input{neuralnetworks/artificial/artificialnn}
\section{Topologies of Artificial Neural Networks}
\input{neuralnetworks/artificial/topologies}
	\subsection{Perceptron}
	\input{neuralnetworks/artificial/perceptron}
	\subsection{Time Delay Neural Networks}
	\input{neuralnetworks/artificial/tdnn}
	\subsection{Non-Linear Autorregresive with Exogenus Input}
	\input{neuralnetworks/artificial/narx}
	\subsection{Spiking Neural Networks}
	\input{neuralnetworks/artificial/snn}
\section{The backpropagation learning algorithm}
\input{neuralnetworks/artificial/backpropagation}

% ADQUISICION SEÑALES
\chapter{Data acquisition}
\input{setup/intro}
\section{Physiological signals}
\input{setup/physiosignals}
\section{The experiment}
\input{setup/experiment}
\section{The symptomatic pain curve}
\input{setup/paincurve}

% APLICACION DE ALGORITMOS
\chapter{Application of Artificial Neural Networks}
\input{nnapplication/intro}
\section{Feedforward networks}
\input{nnapplication/perceptron}
\section{Time Delay Neural Networks}
\input{nnapplication/tdnn}
\section{Non-Linear Autorregresive model with Exogenus Input}
\input{nnapplication/narx}
\section{Spiking Neural Networks}
\input{nnapplication/snn}
